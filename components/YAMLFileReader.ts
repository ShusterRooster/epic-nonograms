...
export default class YAMLFileReader {
    ...
    //hint numbers in each row
    rows: string[][]

    //hint numbers in each column
    columns: string[][]

    //finished state of the puzzle
    goal: string[]

    //goal groupings for each row
    rowGoalPositions: GoalPosition[][]

    //goal groupings for each column
    columnGoalPositions: GoalPosition[][]

    //length of the max # of hint numbers needed for rows
    rowLength: number
    columnLength: number
